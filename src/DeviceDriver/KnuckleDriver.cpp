...
void KnuckleDeviceDriver::SetupProps(vr::PropertyContainerHandle_t& props) {
  ...
  vr::VRProperties()->SetStringProperty(props, vr::Prop_NamedIconPathDeviceOff_String, IsRightHand() ? "{Astr-glove}/icons/right_controller_status_off.png" : "{Astr-glove}/icons/left_controller_status_off.png");
  vr::VRProperties()->SetStringProperty(props, vr::Prop_NamedIconPathDeviceSearching_String, IsRightHand() ? "{Astr-glove}/icons/right_controller_status_searching.gif" : "{Astr-glove}/icons/left_controller_status_searching.gif");
  vr::VRProperties()->SetStringProperty(props, vr::Prop_NamedIconPathDeviceSearchingAlert_String, IsRightHand() ? "{Astr-glove}/icons/right_controller_status_searching_alert.gif" : "{Astr-glove}/icons/left_controller_status_searching_alert.gif");
  vr::VRProperties()->SetStringProperty(props, vr::Prop_NamedIconPathDeviceReady_String, IsRightHand() ? "{Astr-glove}/icons/right_controller_status_ready.png" : "{Astr-glove}/icons/left_controller_status_ready.png");
  vr::VRProperties()->SetStringProperty(props, vr::Prop_NamedIconPathDeviceReadyAlert_String, IsRightHand() ? "{Astr-glove}/icons/right_controller_status_ready_alert.png" : "{Astr-glove}/icons/left_controller_status_ready_alert.png");
  vr::VRProperties()->SetStringProperty(props, vr::Prop_NamedIconPathDeviceNotReady_String, IsRightHand() ? "{Astr-glove}/icons/right_controller_status_error.png" : "{Astr-glove}/icons/left_controller_status_error.png");
  vr::VRProperties()->SetStringProperty(props, vr::Prop_NamedIconPathDeviceStandby_String, IsRightHand() ? "{Astr-glove}/icons/right_controller_status_off.png" : "{Astr-glove}/icons/left_controller_status_off.png");
  vr::VRProperties()->SetStringProperty(props, vr::Prop_NamedIconPathDeviceAlertLow_String, IsRightHand() ? "{Astr-glove}/icons/right_controller_status_ready_low.png" : "{Astr-glove}/icons/left_controller_status_ready_low.png");
